...
export default function Room_Reservation() {
  return (
    <div className="flex flex-auto md:flex-row justify-center items-center h-full gap-6 sm:gap-6 p-10 mt-24 ">
      ...
      >
        <h1
          className="px-6 pt-10 pb-8 text-center text-2xl font-bold font-FCBold"
          style={{
            left: 156,
            top: -18,
            background: "#fff09ce1",
        ...
        <div className="divide-y divide-gray-300/50 space-y-6 py-8 text-base leading-7 text-gray-600  font-FCBold">
